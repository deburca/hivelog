...
/**
 * Form handler for Calendar Action Item Requirement delete forms.
 */
class CalendarActionItemRequirementDeleteForm extends ContentEntityDeleteForm {

  /**
   * {@inheritdoc}
   */
  public function getQuestion() {
    return $this->t('Are you sure you want to delete requirement %label?', [
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $calendar_action_id = $this->entity->get('calendar_action')->target_id;
    $this->entity->delete();
    $this->messenger()->addStatus($this->t('Requirement %label has been deleted.', [
      '%label' => $this->entity->label(),
    ]));
