...
class Queen extends ContentEntityBase implements EntityChangedInterface, EntityOwnerInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['queen_year'] = BaseFieldDefinition::create('integer')
      ...
      ->setDescription(t('The year the queen hatched.'))
      ->setSetting('min', 2000)
    ...
    $fields['queen_colour'] = BaseFieldDefinition::create('list_string')
      ...
      ->setDescription(t('International queen marking colour.'))
    ...
    $fields['purchase_cost'] = BaseFieldDefinition::create('decimal')
      ...
      ->setDisplayOptions('view', ['label' => 'inline', 'type' => 'number_decimal', 'weight' => 6])
      ->setDisplayConfigurable('form', TRUE)
      ->setDisplayConfigurable('view', TRUE);
    $fields['purchase_date'] = BaseFieldDefinition::create('datetime')
      ...
      ->setDisplayOptions('view', ['label' => 'inline', 'type' => 'datetime_default', 'weight' => 7])
      ->setDisplayConfigurable('form', TRUE)
      ->setDisplayConfigurable('view', TRUE);
    $fields['hive'] = BaseFieldDefinition::create('entity_reference')
      ->setLabel(t('Hive'))
      ->setDescription(t('The hive this queen is currently installed in, if any.'))
    ...
    $fields['introduction_date'] = BaseFieldDefinition::create('datetime')
      ...
      ->setSetting('datetime_type', 'date')
      ->setDisplayOptions('form', ['type' => 'datetime_default', 'weight' => 9])
      ->setDisplayOptions('view', ['label' => 'inline', 'type' => 'datetime_default', 'weight' => 9])
      ->setDisplayConfigurable('form', TRUE)
      ->setDisplayConfigurable('view', TRUE);
    $fields['status'] = BaseFieldDefinition::create('list_string')
      ...
      ->setSetting('allowed_values', ['active' => 'Active', 'inactive' => 'Inactive'])
      ->setDisplayOptions('form', ['type' => 'options_select', 'weight' => 10])
      ->setDisplayOptions('view', ['label' => 'inline', 'type' => 'list_default', 'weight' => 10])
      ->setDisplayConfigurable('form', TRUE)
      ->setDisplayConfigurable('view', TRUE);
    $fields['notes'] = BaseFieldDefinition::create('string_long')
      ...
      ->setDisplayOptions('view', ['label' => 'above', 'type' => 'basic_string', 'weight' => 11])
      ->setDisplayConfigurable('form', TRUE)
      ->setDisplayConfigurable('view', TRUE);
    $fields['uid']
      ->setLabel(t('Owner'))
